...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String abbr2(String param, int length) {
        ...
        temp_result = temp_result.replaceAll(
                "</?(AREA|BASE|BASEFONT|BODY|BR|COL|COLGROUP|DD|DT|FRAME|HEAD|HR|HTML|IMG|INPUT|ISINDEX|LI|LINK|META" +
                        "|OPTION|P|PARAM|TBODY|TD|TFOOT|TH|THEAD|TR|area|base|basefont|body|br|col|colgroup|dd|dt" +
                        "|frame|head|hr|html|img|input|isindex|li|link|meta|option|p|param|tbody|td|tfoot|th|thead" +
                        "|tr)[^<>]*/?>",
                "");
        // 去掉成对的HTML标记
    ...
    public static void main(String[] args) {
        System.out.println(DigestUtils.md5Hex("a111111FBoCGa"));
    }
}
